...
public class StandaloneBot extends BotCore implements UpdatesListener, ChannelBot {
    ...
    public boolean chanserv(Long chatId, Nickname nickName, String text, Message originalMessage) {
        boolean answered = false;
        Integer originalMessageId = originalMessage == null? null : originalMessage.messageId();
        log.info("chanserv: ({}, {}, {}, {})", chatId, nickName, text, originalMessageId);
        ...
        if (nCache != null) {
            ...
            if (!(""+nCache).equals(""+nickName)) {
                ...
                sayOnChannel(chatId, "теперь я знаю " + nCache + " как " + nickName + " \uD83D\uDE0E", originalMessageId);
                //saveState();
            } else {
            ...
            members.put(chatId, from_id, nickName);
            sayOnChannel(chatId, "теперь я знаю " + nickName + " \uD83D\uDE0E", originalMessageId);
            saveState();
        }
    ...
    private static String toJson(Update u) {
        return "{ "  + (u.updateId() == null? "" : "\"updateId\": \"" + u.updateId() + "\"") + (u.message() == null? "" : ", \"message\": \"" + toJson(u.message()) + "\"") + (u.editedMessage() == null? "" : ", \"editedMessage\": \"" +  toJson(u.editedMessage()) + "\"") + (u.channelPost() == null? "" : ", \"channelPost\": \"" +  toJson(u.channelPost()) + "\"") + (u.editedChannelPost() == null? "" : ", \"editedChannelPost\": \"" +  toJson(u.editedChannelPost()) + "\"") + (u.inlineQuery() == null? "" : ", \"inlineQuery\": \"" + u.inlineQuery() + "\"") + (u.chosenInlineResult() == null? "" : ", \"chosenInlineResult\": \"" + u.chosenInlineResult() + "\"") + (u.callbackQuery() == null? "" : ", \"callbackQuery\": \"" + u.callbackQuery() + "\"") + (u.shippingQuery() == null? "" : ", \"shippingQuery\": \"" + u.shippingQuery() + "\"") + (u.preCheckoutQuery() == null? "" : ", \"preCheckoutQuery\": \"" + u.preCheckoutQuery() + "\"") + (u.poll() == null? "" : ", \"poll\": \"" + u.poll() + "\"") + (u.pollAnswer() == null? "" : ", \"pollAnswer\": \"" + u.pollAnswer() + "\"") + (u.myChatMember() == null? "" : ", \"myChatMember\": \"" + u.myChatMember() + "\"") + (u.chatMember() == null? "" : ", \"chatMember\": \"" + u.chatMember() + "\"") + (u.chatJoinRequest() == null? "" : ", \"chatJoinRequest\": \"" + u.chatJoinRequest() + "\"") + " }";
    ...
    private static String toJson(Message m) {
        return "{ "  +  (m.messageId() == null? "" : "\"messageId\": \"" + m.messageId() + "\"") + (m.messageThreadId() == null? "" : ", \"messageThreadId\": \"" + m.messageThreadId() + "\"") + (m.from() == null? "" : ", \"from\": \"" + m.from() + "\"") + (m.senderChat() == null? "" : ", \"senderChat\": \"" + m.senderChat() + "\"") + (m.date() == null? "" : ", \"date\": \"" + m.date() + "\"") + (m.chat() == null? "" : ", \"chat\": \"" + m.chat() + "\"") + (m.forwardFrom() == null? "" : ", \"forwardFrom\": \"" + m.forwardFrom() + "\"") + (m.forwardFromChat() == null? "" : ", \"forwardFromChat\": \"" + m.forwardFromChat() + "\"") + (m.forwardFromMessageId() == null? "" : ", \"forwardFromMessageId\": \"" + m.forwardFromMessageId() + "\"") + (m.forwardSignature() == null? "" : ", \"forwardSignature\": \"" + m.forwardSignature() + "\"") + (m.forwardSenderName() == null? "" : ", \"forwardSenderName\": \"" + m.forwardSenderName() + "\"") + (m.forwardDate() == null? "" : ", \"forwardDate\": \"" + m.forwardDate() + "\"") + (m.isTopicMessage() == null? "" : ", \"isTopicMessage\": \"" + m.isTopicMessage() + "\"") + (m.isAutomaticForward() == null? "" : ", \"isAutomaticForward\": \"" + m.isAutomaticForward() + "\"") + (m.replyToMessage() == null? "" : ", \"replyToMessage\": \"" + m.replyToMessage() + "\"") + (m.viaBot() == null? "" : ", \"viaBot\": \"" + m.viaBot() + "\"") + (m.editDate() == null? "" : ", \"editDate\": \"" + m.editDate() + "\"") + (m.hasProtectedContent() == null? "" : ", \"hasProtectedContent\": \"" + m.hasProtectedContent() + "\"") + (m.hasMediaSpoiler() == null? "" : ", \"hasMediaSpoiler\": \"" + m.hasMediaSpoiler() + "\"") + (m.mediaGroupId() == null? "" : ", \"mediaGroupId\": \"" + m.mediaGroupId() + "\"") + (m.authorSignature() == null? "" : ", \"authorSignature\": \"" + m.authorSignature() + "\"") + (m.text() == null? "" : ", \"text\": \"" + m.text() + "\"") + (m.entities() == null? "" : ", \"entities\": \"" + m.entities() + "\"") + (m.captionEntities() == null? "" : ", \"captionEntities\": \"" + m.captionEntities() + "\"") + (m.audio() == null? "" : ", \"audio\": \"" + m.audio() + "\"") + (m.document() == null? "" : ", \"document\": \"" + m.document() + "\"") + (m.animation() == null? "" : ", \"animation\": \"" + m.animation() + "\"") + (m.game() == null? "" : ", \"game\": \"" + m.game() + "\"") + (m.photo() == null? "" : ", \"photo\": \"" + m.photo() + "\"") + (m.sticker() == null? "" : ", \"sticker\": \"" + m.sticker() + "\"") + (m.video() == null? "" : ", \"video\": \"" + m.video() + "\"") + (m.voice() == null? "" : ", \"voice\": \"" + m.voice() + "\"") + (m.videoNote() == null? "" : ", \"videoNote\": \"" + m.videoNote() + "\"") + (m.caption() == null? "" : ", \"caption\": \"" + m.caption() + "\"") + (m.contact() == null? "" : ", \"contact\": \"" + m.contact() + "\"") + (m.location() == null? "" : ", \"location\": \"" + m.location() + "\"") + (m.venue() == null? "" : ", \"venue\": \"" + m.venue() + "\"") + (m.poll() == null? "" : ", \"poll\": \"" + m.poll() + "\"") + (m.dice() == null? "" : ", \"dice\": \"" + m.dice() + "\"") + (m.newChatMembers() == null? "" : ", \"newChatMembers\": \"" + m.newChatMembers() + "\"") + (m.leftChatMember() == null? "" : ", \"leftChatMember\": \"" + m.leftChatMember() + "\"") + (m.newChatTitle() == null? "" : ", \"newChatTitle\": \"" + m.newChatTitle() + "\"") + (m.newChatPhoto() == null? "" : ", \"newChatPhoto\": \"" + m.newChatPhoto() + "\"") + (m.deleteChatPhoto() == null? "" : ", \"deleteChatPhoto\": \"" + m.deleteChatPhoto() + "\"") + (m.groupChatCreated() == null? "" : ", \"groupChatCreated\": \"" + m.groupChatCreated() + "\"") + (m.supergroupChatCreated() == null? "" : ", \"supergroupChatCreated\": \"" + m.supergroupChatCreated() + "\"") + (m.channelChatCreated() == null? "" : ", \"channelChatCreated\": \"" + m.channelChatCreated() + "\"") + (m.messageAutoDeleteTimerChanged() == null? "" : ", \"messageAutoDeleteTimerChanged\": \"" + m.messageAutoDeleteTimerChanged() + "\"") + (m.migrateToChatId() == null? "" : ", \"migrateToChatId\": \"" + m.migrateToChatId() + "\"") + (m.migrateFromChatId() == null? "" : ", \"migrateFromChatId\": \"" + m.migrateFromChatId() + "\"") + (m.pinnedMessage() == null? "" : ", \"pinnedMessage\": \"" + m.pinnedMessage() + "\"") + (m.invoice() == null? "" : ", \"invoice\": \"" + m.invoice() + "\"") + (m.successfulPayment() == null? "" : ", \"successfulPayment\": \"" + m.successfulPayment() + "\"") + (m.story() == null? "" : ", \"story\": \"" + m.story() + "\"") + (m.userShared() == null? "" : ", \"userShared\": \"" + m.userShared() + "\"") + (m.chatShared() == null? "" : ", \"chatShared\": \"" + m.chatShared() + "\"") + (m.connectedWebsite() == null? "" : ", \"connectedWebsite\": \"" + m.connectedWebsite() + "\"") + (m.passportData() == null? "" : ", \"passportData\": \"" + m.passportData() + "\"") + (m.proximityAlertTriggered() == null? "" : ", \"proximityAlertTriggered\": \"" + m.proximityAlertTriggered() + "\"") + (m.forumTopicCreated() == null? "" : ", \"forumTopicCreated\": \"" + m.forumTopicCreated() + "\"") + (m.forumTopicEdited() == null? "" : ", \"forumTopicEdited\": \"" + m.forumTopicEdited() + "\"") + (m.forumTopicClosed() == null? "" : ", \"forumTopicClosed\": \"" + m.forumTopicClosed() + "\"") + (m.forumTopicReopened() == null? "" : ", \"forumTopicReopened\": \"" + m.forumTopicReopened() + "\"") + (m.generalForumTopicHidden() == null? "" : ", \"generalForumTopicHidden\": \"" + m.generalForumTopicHidden() + "\"") + (m.generalForumTopicUnhidden() == null? "" : ", \"generalForumTopicUnhidden\": \"" + m.generalForumTopicUnhidden() + "\"") + (m.writeAccessAllowed() == null? "" : ", \"writeAccessAllowed\": \"" + m.writeAccessAllowed() + "\"") + (m.videoChatStarted() == null? "" : ", \"videoChatStarted\": \"" + m.videoChatStarted() + "\"") + (m.videoChatEnded() == null? "" : ", \"videoChatEnded\": \"" + m.videoChatEnded() + "\"") + (m.videoChatParticipantsInvited() == null? "" : ", \"videoChatParticipantsInvited\": \"" + m.videoChatParticipantsInvited() + "\"") + (m.videoChatScheduled() == null? "" : ", \"videoChatScheduled\": \"" + m.videoChatScheduled() + "\"") + (m.replyMarkup() == null? "" : ", \"replyMarkup\": \"" + m.replyMarkup() + "\"") + (m.webAppData() == null? "" : ", \"webAppData\": \"" + m.webAppData() + "\"") + " }";
    }
